...
for module in board.GetFootprints():
    ...
    module.Reference().SetTextHeight(300000)
    module.Reference().SetTextWidth(300000)
    module.Reference().SetTextThickness(30000)
    print(module.Reference().GetTextPos())
    print(module.Reference().GetPosition())
    module.Value().SetTextHeight(300000)
    module.Value().SetTextWidth(300000)
    module.Value().SetTextThickness(30000)
