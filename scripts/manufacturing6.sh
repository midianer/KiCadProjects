...
export PROJECT=eload
export MPATH="$PROJECT"_manufacturing
mydate=`date '+%Y-%m-%d_%H-%M-%S'`
echo $mydate

pushd ../${PROJECT}
python3 ../scripts/plot_pdf6.py ${PROJECT}.kicad_pcb 1.1
...
pushd ../
zip -r ${PROJECT}_${mydate}_manu.zip  ${PROJECT}/Gerber/ ${PROJECT}/${PROJECT}.step ${PROJECT}/${PROJECT}.csv ${PROJECT}/${PROJECT}.kicad_pcb
zip -r ${PROJECT}_${mydate}_devel.zip  ${PROJECT}/Gerber/ ${PROJECT}/LayerPDF/ ${PROJECT}/SchemaPDF/ ${PROJECT}/${PROJECT}.step ${PROJECT}/${PROJECT}.csv
